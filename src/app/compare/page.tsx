  ...
  return (
    <main dir="rtl" className="min-h-screen bg-slate-950 px-5 py-10 text-slate-100 md:px-12">
      <div className="mx-auto max-w-6xl">
        <p className="text-sm font-bold text-teal-300">اتاق تصمیم · نسخه نمایشی</p>
        <h1 className="mt-3 text-3xl font-black">مقایسه سه نماد</h1>
        <p className="mt-3 text-slate-300">امتیازها نمونه هستند و تا زمان مجوز مکتوب داده، داده زنده نمایش داده نمی‌شود.</p>
        <div className="mt-8 overflow-x-auto rounded-2xl border border-slate-800 bg-slate-900">
          <table className="w-full min-w-[720px] text-right">
            <thead className="border-b border-slate-800 text-sm text-slate-400"><tr><th className="p-4">نماد</th><th>نقدشوندگی</th><th>تاب‌آوری</th><th>بنیادی</th><th>افشا</th><th className="p-4">امتیاز شفاف</th></tr></thead>
